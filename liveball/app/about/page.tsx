    ...
    <main style={{ minHeight: "100vh", fontFamily: "system-ui, sans-serif", background: "#f9fafb", padding: "3rem 2rem" }}>
      <div style={{ maxWidth: "720px", margin: "0 auto", overflowWrap: "break-word" }}>
        ...
        <p style={bodyText}>
          ...
          {" "}if you're curious), but the general calculations are important to know. The statistic uses two components, true points (TP) and true scoring possessions used (TSPU), and then divides TP by TSPU and multiples by 0.5 (Multiplies by 0.5 to match the true shooting scale).
        </p>
        ...
        <p style={{ ...bodyText, marginTop: "10px" }}>
          <strong>TSE Add:</strong> This statistic determines how many points you add (or subtract) through your TSE and TSPU. 
        </p>
